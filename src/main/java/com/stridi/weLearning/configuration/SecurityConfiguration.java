package com.stridi.weLearning.configuration;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.stridi.weLearning.configuration.error.ErrorResponse;
import lombok.RequiredArgsConstructor;
import com.stridi.weLearning.security.TokenAuthenticationFilter;
import com.stridi.weLearning.security.TokenAuthenticationProvider;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    private static final RequestMatcher PROTECTED_URLS = new OrRequestMatcher(
        new AntPathRequestMatcher("/api/student/**"),
        new AntPathRequestMatcher("/api/professor/**")
    );
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeRequests()
            .antMatchers("/api/student/**", "/api/professor/**")
            .authenticated()
            .and()
            .csrf().disable()
            .formLogin().disable()
